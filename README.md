...
* Change the variables for enabling Apache, Nginx and MySQL in the `dev.yml` file in the `env-vars` directory to meet the conditons for executing the MySQL role.
